<div class="min-w-3xs max-w-3xs h-svh bg-slate-800 flex flex-col">
    ...
    <ul class="w-full flex flex-col gap-2 px-6 py-4">
        <li>
            <a href="{{route('home')}}" class="flex items-center gap-4 hover:cursor-pointer hover:bg-slate-700 px-4 py-2 rounded-md transition-all duration-200">
        ...
        <li>
            <a href="{{route('about')}}" class="flex items-center gap-4 hover:cursor-pointer hover:bg-slate-700 px-4 py-2 rounded-md transition-all duration-200">
